    ...
    render(){
        return (
            <React.Fragment>
                ...
                <div className="modal__videoFooter">
                    <button onClick={this.props.openTest} type="button" class="btn btn-primary modal__videoFooter-button">Sigue con el test</button>
                </div>
            </React.Fragment>
        )
    }
